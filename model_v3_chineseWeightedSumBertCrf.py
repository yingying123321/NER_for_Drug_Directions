...
# bert配置
config_path = '/home/liulinhai/llhy/bert/google_chineseBert/chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/home/liulinhai/llhy/bert/google_chineseBert/chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/home/liulinhai/llhy/bert/google_chineseBert/chinese_L-12_H-768_A-12/vocab.txt'
...
#         print(NER.trans)
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('./best_model_epoch_20_bertCrf_albertbase.weights')
        print(
...
callbacks = [evaluator, keras.callbacks.EarlyStopping(patience=5, min_delta=1e-3)]
